...
<html lang="en">
  <head>
    ...
    <title>Configurações de Frete</title>
    <style>
  ...
  <body>
   ...
   <div class="container">
      ...
      <main>
        ...
        <div class="insights">
          <p>Aqui serão configuradas as opções de frete e logística.</p>
          <!-- Adicione o conteúdo específico da página de configurações de frete aqui -->
        </div>
      </main>
