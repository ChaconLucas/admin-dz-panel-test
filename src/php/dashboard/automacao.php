  ...
  <body>
   ...
   <div class="container">
      ...
      <main>
        ...
        <div class="insights">
          <p>Aqui serão configuradas as automações e fluxos automatizados do sistema.</p>
          <!-- Adicione o conteúdo específico da página de configurações de automação aqui -->
        </div>
      </main>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (savedTheme === 'true') {
        ...
        console.log('Tema dark aplicado em automacao.php');
    }
});
</script>
 </body>
